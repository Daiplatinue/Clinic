...
<head>
    ...
    <title>Clinic School Management</title>
    <meta charset="utf-8">
        ...
        <div class="flex flex-wrap items-center justify-center -mx-4">
            <div class="w-full lg:w-1/2 px-4 mb-8 lg:mb-0">
                <div class="space-y-8 slide-in">
                    <div class="space-y-4">
                        ...
                        <div class="space-y-2">
                            <h2 class="text-4xl md:text-5xl font-bold text-gray-100 slide-in">Clinic School</h2>
            ...
            <div class="w-full lg:w-1/2 px-4">
                <div class="glass-effect rounded-3xl p-8 shadow-2xl slide-in">
                    <div class="flex justify-center mb-8">
                        <div class="bg-dark-200/50 rounded-full p-2">
                            <div class="flex space-x-2">
                                <button onclick="switchForm('login')" class="px-8 py-3 rounded-full transition-all duration-300 text-lg" id="loginBtn">
                                    Login
                                </button>
                                <button onclick="switchForm('register')" class="px-8 py-3 rounded-full transition-all duration-300 text-lg" id="registerBtn">
                                    Register
                                </button>
                            </div>
                        </div>
                    ...
                    <!-- Register Form -->
                    <form id="registerForm" class="space-y-6 hidden" method="POST" action="../server/reg.php">
                        <div class="relative group">
                            <i class="fas fa-user absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 group-hover:text-blue-500 transition-colors"></i>
                            <input type="text" class="w-full bg-dark-200/50 rounded-lg px-10 py-4 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300" placeholder="Full Name" name="fullname">
                        </div>
                        <div class="relative group">
                            <i class="fas fa-envelope absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 group-hover:text-blue-500 transition-colors"></i>
                            <input type="text" class="w-full bg-dark-200/50 rounded-lg px-10 py-4 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300" placeholder="Email" name="email">
                        ...
                        <div class="relative group">
                            <i class="fas fa-lock absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 group-hover:text-blue-500 transition-colors"></i>
                            <select name="bloodtype" class="w-full bg-dark-200/50 rounded-lg px-10 py-4 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300" required>
                        ...
                        <div class="relative group">
                            <i class="fas fa-lock absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 group-hover:text-blue-500 transition-colors"></i>
                            <select name="grade" class="w-full bg-dark-200/50 rounded-lg px-10 py-4 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300" required>
    ...
    <script>
        function switchForm(form) {
            ...
            if (form === 'login') {
                ...
                loginBtn.classList.add('bg-gradient-to-r', 'from-blue-500', 'to-purple-600', 'text-white');
                registerBtn.classList.remove('bg-gradient-to-r', 'from-blue-500', 'to-purple-600', 'text-white');
            } else {
                loginForm.classList.add('hidden');
                registerForm.classList.remove('hidden');
                registerBtn.classList.add('bg-gradient-to-r', 'from-blue-500', 'to-purple-600', 'text-white');
                loginBtn.classList.remove('bg-gradient-to-r', 'from-blue-500', 'to-purple-600', 'text-white');
            }
        }
