...
<body class="bg-gray-50 dark:bg-gray-900">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <!-- Main Content -->
            <main class="flex-1 overflow-y-auto text-white">
            ...
            <div id="editModal" class="modal hidden fixed inset-0 bg-black bg-opacity-50 overflow-y-auto h-full w-full p-4 z-50">
                <div class="m-auto bg-dark-100 rounded-xl p-8 w-full max-w-2xl animate-fade-in text-white">
                    ...
                    <form method="POST" id="editForm" onsubmit="handleSubmit(event)" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="grade" value="<?php echo htmlspecialchars($email); ?>"
                                    class="w-full bg-dark-400 border border-gray-700 rounded-lg px-4 py-2 text-white">
                            </div>
                            <div>
                                <label class="block text-gray-400 mb-2">Status</label>
                                <select name="status" class="w-full bg-dark-400 border border-gray-700 rounded-lg px-4 py-2 text-white">
                                    <option value="available" <?php echo $gender === 'available' ? 'selected' : ''; ?>>Available</option>
                                    <option value="busy" <?php echo $gender === 'busy' ? 'selected' : ''; ?>>Busy</option>
                                    <option value="away" <?php echo $gender === 'away' ? 'selected' : ''; ?>>Away</option>
                                </select>
                            </div>
                            <div>
                                <label class="block text-gray-400 mb-2">Working Hours</label>
                                <select name="status" class="w-full bg-dark-400 border border-gray-700 rounded-lg px-4 py-2 text-white">
                                    <option value="available" <?php echo $gender === 'available' ? 'selected' : ''; ?>>8:00 AM - 4:00 PM</option>
                                    <option value="available" <?php echo $gender === 'available' ? 'selected' : ''; ?>>1:00 PM - 5:00 PM</option>
                                    <option value="busy" <?php echo $gender === 'busy' ? 'selected' : ''; ?>>7:00 AM - 8:00 PM</option>
                                    <option value="away" <?php echo $gender === 'away' ? 'selected' : ''; ?>>3:00 PM - 10:00 PM</option>
                                </select>
                            </div>
                        </div>
